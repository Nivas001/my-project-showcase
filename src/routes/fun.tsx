...
export function FunPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-12 sm:py-20">
      ...
      <div className="reveal mt-8 rounded-md border border-border bg-card p-6 sm:p-10">
      ...
      <div className="reveal mt-12 text-center font-mono text-xs text-muted-foreground">
