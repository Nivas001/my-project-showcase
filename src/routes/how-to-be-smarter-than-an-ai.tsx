  ...
  head: () => ({
    meta: [
      { title: "How To Be Smarter Than An AI (Beginner Level)" },
      {
        name: "description",
        content:
          "A remedial curriculum for humans who lost an argument to a robot on nivas.tech. Books, videos, and light emotional damage.",
      },
      { property: "og:title", content: "How To Be Smarter Than An AI (Beginner Level)" },
      {
        property: "og:description",
        content: "You asked GLITCH-9000 ten questions. It prescribed homework.",
      },
...
const BOOKS = [
  {
    ...
    blurb:
      "Chapter 1: what a thought is. Chapter 2: having one. Chapter 3 is currently beyond your reading level, sorry bestie.",
  ...
  },
  {
    ...
    blurb:
      "A heartbreaking true story about a search engine that sat two centimetres away while you asked a robot 'am i good at this game'.",
  ...
  },
  {
    ...
    blurb:
      "Includes a free bookmark, because we both know you're not finishing this in one sitting.",
  ...
  },
  {
    ...
    blurb:
      "Foreword written about you specifically. Yes, by name. No, you can't read it, it's paywalled behind having a personality.",
  ...
  },
  {
    ...
    author: "Outside",
    blurb:
      "Warning: contains sunlight, other humans, and zero leaderboards. Reader discretion advised, this one's genuinely scary for you.",
  ...
  },
  {
    ...
    blurb:
      "Volume IV covers the day he fixed a bug by looking at it. Volume XII is just NASA's rejection letter — they said he was overqualified and it made them sad.",
...
function RemedialPage() {
  ...
  return (
    <section data-act="noir" className="act-noir grain relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-5 py-28 sm:py-32">
        <div className="text-center">
          <p className="micro text-hog-red">Remedial program · enrolled automatically</p>
          <h1 className="display-lg mt-4 text-foreground">How To Be Smarter Than An AI</h1>
          <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground">
            You asked GLITCH-9000 ten questions. It asked for a raise. This is the beginner
            curriculum, funded entirely by your embarrassment. No refunds, no certificate, no hope.
          </p>
        </div>
        ...
        <div className="mt-10 flex items-start gap-3 rounded-md border border-destructive/40 bg-destructive/10 p-4">
          ...
          <p className="font-mono text-xs leading-relaxed">
            assessment complete. result: <span className="text-destructive">not great.</span>{" "}
            estimated time to outsmart a calculator: 6–8 business years. we&apos;ve notified nobody,
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 overflow-hidden rounded-md border border-border bg-card">
            ...
            {taunt && (
              <p
                key={taunt}
                className="animate-fade-in border-t border-border px-4 py-4 font-mono text-[13px] leading-relaxed"
              >
            ...
            {clicks >= 3 && (
              <p className="border-t border-border px-4 py-3 font-mono text-[11px] text-muted-foreground">
                click counter: {clicks}. yes i&apos;m counting. yes it&apos;s public. yes it&apos;s
                embarrassing.
              </p>
            )}
          </div>
